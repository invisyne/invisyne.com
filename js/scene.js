...
const VIEWS = [
  { key: 'Signals',     lines: 1.0,  alarms: 0.18, forecast: 0, context: 0, life: 0.45, phases: 0 },
  { key: 'Alarms',      lines: 0.55, alarms: 1.0,  forecast: 0, context: 0, life: 0.35, phases: 0 },
  { key: 'Predictions', lines: 0.7,  alarms: 0.12, forecast: 1, context: 0, life: 0.35, phases: 0 },
  { key: 'Lifecycle',   lines: 0.55, alarms: 0.2,  forecast: 0, context: 0, life: 1.0,  phases: 1 },
  { key: 'Context',     lines: 0.5,  alarms: 0.1,  forecast: 0, context: 1, life: 0.55, phases: 0 },
];
...
const KEYS = ['lines', 'alarms', 'forecast', 'context', 'life', 'phases'];

function viewAlphas(dt) {
  if (REDUCE) {
    const v = VIEWS[0];
    return { lines: v.lines, alarms: v.alarms, forecast: 0, context: 0, life: v.life, phases: 0,
